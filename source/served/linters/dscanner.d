...
void adjustRangeForType(ref Diagnostic d, Document document, DScannerIssue issue)
{
	switch (issue.key)
	{
	case null:
		// syntax errors
		adjustRangeForSyntaxError(d, document, issue);
		break;
	default:
...
private void adjustRangeForSyntaxError(ref Diagnostic d, Document document, DScannerIssue issue)
{
